...
/**
 * WEB GATEWAY SERVER
 * Acts as a bridge between the Web Frontend (HTTP) and Distributed Backend (TCP Sockets).
 * Handles:
...
public class WebGatewayServer {
    ...
    // Backend Config
    private static final String DISPATCH_HOST = System.getenv("DISPATCH_HOST") != null ? System.getenv("DISPATCH_HOST") : "localhost";
    private static final int DISPATCH_PORT = 5000;
    private static final String DRIVER_HOST = System.getenv("DRIVER_HOST") != null ? System.getenv("DRIVER_HOST") : "localhost";
    ...
    static class StaticFileHandler implements HttpHandler {
        ...
        public StaticFileHandler(String path) { this.filePath = path; }
        ...
        public void handle(HttpExchange t) throws IOException {
            ...
            // Set content type
            if (filePath.endsWith(".html")) t.getResponseHeaders().set("Content-Type", "text/html");
            if (filePath.endsWith(".css")) t.getResponseHeaders().set("Content-Type", "text/css");
            if (filePath.endsWith(".js")) t.getResponseHeaders().set("Content-Type", "application/javascript");
    ...
    static class DirectoryHandler implements HttpHandler {
        ...
        public DirectoryHandler(String dir) { this.rootDir = dir; }
        ...
        public void handle(HttpExchange t) throws IOException {
            ...
            if (fileName.endsWith(".css")) t.getResponseHeaders().set("Content-Type", "text/css");
            if (fileName.endsWith(".js")) t.getResponseHeaders().set("Content-Type", "application/javascript");
    ...
    static class DriverProxyHandler implements HttpHandler {
        ...
        public void handle(HttpExchange t) throws IOException {
             ...
             // For web, we'll assume stateless updates for simplicity or implement a simple registration
             // In a real web app, we'd use WebSockets. Here we'll do simple HTTP->TCP command firing.
    ...
    private static void handleProxy(HttpExchange t, String host, int port) throws IOException {
        ...
        if ("POST".equals(t.getRequestMethod())) {
            ...
            try (Socket socket = new Socket(host, port);
                ...
                if (resp != null) jsonResponse = resp;
    ...
    static class DirectionProxyHandler implements HttpHandler {
        ...
        public void handle(HttpExchange t) throws IOException {
            ...
            if ("GET".equals(t.getRequestMethod())) {
                String query = t.getRequestURI().getQuery();
                // Expected query: originLat=...&originLon=...&destLat=...&destLon=...&apiKey=...
    ...
    static class AuthHandler implements HttpHandler {
        ...
        public AuthHandler(boolean isRegister) { this.isRegister = isRegister; }
    ...
    static class AdminAssignHandler implements HttpHandler {
        ...
        public void handle(HttpExchange t) throws IOException {
             ...
             if ("POST".equals(t.getRequestMethod())) {
                 ...
                 // Manual Fix: PassengerHandler doesn't support ASSIGN_DRIVER yet (it treats as client).
